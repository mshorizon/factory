  ...
  return (
    <div className={cn("relative", className)}>
      ...
      <ScrollReveal delay={0.3} direction="up">
        <div className="flex items-center justify-center gap-2 mb-spacing-lg">
      ...
      {/* Gradient edges */}
      <div className="absolute left-0 top-12 bottom-0 w-16 bg-gradient-to-r from-background to-transparent z-10 pointer-events-none" />
      <div className="absolute right-0 top-12 bottom-0 w-16 bg-gradient-to-l from-background to-transparent z-10 pointer-events-none" />

      {/* Scrollable container */}
      <div
        ref={scrollRef}
        className={cn(
          "flex gap-spacing-lg overflow-x-auto pb-4 scrollbar-hide snap-x snap-mandatory",
