              ...
              >
                ...
                {project.url && (
                  <a
                    ...
                    className="inline-flex items-center gap-2 mt-spacing-lg px-4 py-2 border border-primary text-primary rounded-radius text-sm font-medium hover:bg-primary hover:text-primary-foreground transition-colors w-fit select-none"
