          ...
          return (
            <ScrollReveal key={index} delay={index * 0.1} direction="up" distance={30}>
              <a
                ...
                className="group flex h-full flex-col overflow-hidden rounded-radius border border-border/[0.03] bg-surface-alt transition-colors duration-300 hover:border-primary"
