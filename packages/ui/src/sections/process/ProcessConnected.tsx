        ...
        {steps.map((step, index) => {
          ...
          return (
            <StaggerItem key={index} direction="up" distance={30}>
              <div
                className="bg-card border border-border/20 rounded-[1.25rem] p-spacing-lg h-full flex flex-col transition-all duration-200 hover:-translate-y-1.5 hover:shadow-xl hover:shadow-primary/10"
