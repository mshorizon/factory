  ...
  return (
    ...
    >
      <div className="flex items-center gap-spacing-md min-w-0">
        ...
        <div className="flex flex-row items-center flex-wrap gap-spacing-sm min-w-0">
          <span className="text-foreground font-medium text-sm break-words">{file.name}</span>
          <span className="flex-shrink-0 inline-flex px-2.5 py-0.5 text-xs font-bold uppercase tracking-wider rounded-full bg-primary-light text-on-primary">
            {ext}
          </span>
        </div>
      </div>
