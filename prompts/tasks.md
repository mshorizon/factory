# Kierunki rozwoju MS Horizon Factory
...
## 3. Analytics dla właścicieli biznesów
...
## 8. Powiadomienia push / SMS

- [ ] Integracja z Twilio lub SMSAPI
- [ ] SMS przy nowym zamówieniu / rezerwacji (do właściciela)
- [ ] SMS przypomnienie o rezerwacji (do klienta)
