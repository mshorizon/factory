...
This is the heads-up the user needs before running `/sdd-bootstrapper`. It also lands in `hints.bootstrapper_confidence` so bootstrapper itself can adjust its scaffolding behavior.
