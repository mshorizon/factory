...
function adaptTheme(theme: ThemeV10): ThemeV15 {
  const isLightMode = hexLuminance(theme.colors.background) > hexLuminance(theme.colors.foreground);
    ...
    colors: {
      light: {
        ...
        text: {
          ...
          muted: theme.colors.muted || theme.colors.foreground,
          onPrimary: hexLuminance(theme.colors.primary) > 0.5 ? "#000000" : "#ffffff",
        },
      },
    },
    typography: {
