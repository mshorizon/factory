...
export default function SectionEditor({ section, savedSection, index, sectionCount, pageName, businessId, majorTheme, onUpdate, onRemove, onMoveUp, onMoveDown }: SectionEditorProps) {
  ...
  const majorThemeDefaults: Record<string, Record<string, string>> = {
    ...
    "portfolio-art": { hero: "split", services: "grid", categories: "featured", about: "story", contact: "split", testimonials: "default", faq: "default", features: "default", ctaBanner: "default", process: "default", pricing: "default", project: "grid", blog: "default", shop: "grid", comparison: "default", team: "default", trustBar: "default" },
    "portfolio-law": { hero: "split", services: "grid", categories: "featured", about: "story", contact: "minimal", testimonials: "centered", faq: "split", features: "icon-tiles", ctaBanner: "default", process: "default", pricing: "default", project: "grid", blog: "cards-light", shop: "grid", comparison: "default", team: "default", trustBar: "default" },
  };
