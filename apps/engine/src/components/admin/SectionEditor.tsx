...
export default function SectionEditor({ section, savedSection, index, sectionCount, pageName, businessId, majorTheme, onUpdate, onRemove, onMoveUp, onMoveDown }: SectionEditorProps) {
  ...
  const majorThemeDefaults: Record<string, Record<string, string>> = {
    "template-specialist": { hero: "split", services: "darkCards", categories: "carousel", about: "story", contact: "split", testimonials: "default", faq: "default", features: "default", ctaBanner: "default", process: "default", pricing: "default", project: "grid", blog: "default", shop: "grid", comparison: "default", team: "default", trustBar: "default" },
    "template-tech": { hero: "gradient", services: "alternating", categories: "featured", about: "story", contact: "split", testimonials: "gradient", faq: "bordered", features: "gradient", ctaBanner: "card", process: "grid", pricing: "xtract", project: "horizontal", blog: "default", shop: "grid", comparison: "default", team: "default", trustBar: "logos" },
    "template-art": { hero: "split", services: "grid", categories: "featured", about: "story", contact: "split", testimonials: "default", faq: "default", features: "default", ctaBanner: "default", process: "default", pricing: "default", project: "grid", blog: "default", shop: "grid", comparison: "default", team: "default", trustBar: "default" },
    "template-law": { hero: "split", services: "grid", categories: "featured", about: "story", contact: "minimal", testimonials: "centered", faq: "split", features: "icon-tiles", ctaBanner: "default", process: "default", pricing: "default", project: "grid", blog: "cards-light", shop: "grid", comparison: "default", team: "default", trustBar: "default" },
  };
