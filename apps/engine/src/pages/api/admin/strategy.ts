  ...
  if (action === "generate") {
    try {
      const task = await createTask({
        ...
        location: "admin/strategy",
        page: "strategy",
        section: "administration",
        isAdminPanel: true,
        description: "Generate strategic suggestions for Hazelgrouse Studio. Run the strategic-scheduler script: `DATABASE_URL=\"...\" ANTHROPIC_API_KEY=\"...\" tsx scripts/strategic-scheduler.ts`",
        isSuperAdmin: true,
      });
