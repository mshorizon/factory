...
#### Automated
- [x] 2.1 Monorepo type-check passes: `pnpm type-check` — 05b86423
...
#### Automated
- [x] 3.1 Monorepo type-check passes: `pnpm type-check` — 1bd03115
- [x] 3.2 Engine builds: `pnpm --filter @mshorizon/engine build` — 1bd03115
- [x] 3.3 `pnpm goal:resolve` exits cleanly with a helpful message when no accepted bug step — 1bd03115
...
#### Automated
- [x] 4.1 Monorepo type-check passes: `pnpm type-check` — 04d8bd7a
