...
const IMAGE_URL = "https://framerusercontent.com/images/egD88r5rgop1Wku37LhyRI0kScw.jpg";
const BUSINESS_ID = "specialist-001";
const IMAGE_FILENAME = "faq-electrician.jpg";
...
async function main() {
  try {
    console.log("🚀 Starting FAQ image upload...\n");
    ...
    console.log(`\n🌐 New image URL: ${r2Url}`);
    console.log("\nUse this URL in the template for the FAQ section image.");
