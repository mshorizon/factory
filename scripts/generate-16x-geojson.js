// Generate 16x detailed GeoJSON for Poland and Mazowieckie
...
function interpolate(coords, factor = 16) {
  const result = [];
...
const polandDetailed = interpolate(polandBase, 16);
const mazowieckieDetailed = interpolate(mazowieckieBase, 16);
