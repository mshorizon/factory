// Generate 10x detailed GeoJSON for Poland and Mazowieckie
...
function interpolate(coords, factor = 10) {
  const result = [];
...
const polandDetailed = interpolate(polandBase, 10);
const mazowieckieDetailed = interpolate(mazowieckieBase, 10);
