...
## Phase 3 — Scale to 10 (Week 9–16)

### Referrals
- [ ] Ask each closed client for 1 referral: "Czy znasz kogoś w podobnej branży bez strony?"
- [ ] Offer 1 free month (99 zł credit) for a successful referral
- [ ] Track referral pipeline separately

### Automate the demo pipeline
- [ ] Build or extend Google Maps scraper to collect leads with contact info automatically
- [ ] Semi-automate JSON pre-fill from business name + GMB data
